...
const AdminDashboardui = () => {
    return (
        <>
            ...
            <section className="flex justify-center items-center py-10 h-[50vh] bg-[#000000]">
                <h1 className="text-white text-6xl text-bold">This is a admin page </h1>
            </section>
