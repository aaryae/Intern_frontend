...
const Adminhome = () => {
    return (
        <div className="bg-gray-300 antialiased w-full">
            <div className=" px-auto py-60">


                <div className="bg-transparent relative shadow rounded-lg w-5/6 md:w-5/6  lg:w-4/6 xl:w-3/6 mx-auto">
                    ...
                    <div className="mt-16">
                        <h1 className="font-bold text-center text-3xl text-gray-900">aaryae Software</h1>
                        <p className="text-center text-sm text-gray-400 font-medium">aaryae Components Factory</p>
                        <p>
                            <span>
                            </span>
                        </p>
                        <div className="my-5 px-6">
                            <a href="#" className="text-gray-200 block rounded-lg text-center font-medium leading-6 px-6 py-3 bg-gray-900 hover:bg-black hover:text-white">Connect with <span className="font-bold">@aaryae</span></a>
                        </div>
