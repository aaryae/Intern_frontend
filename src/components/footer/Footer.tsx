...
const Footer = () => {
    return (
        ...
        <footer className="lingrad text-white absolute w-full  bottom-min-content">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://news.aaryadangol.com.np/" className="flex items-center">
                            <span className="self-center  font-semibold whitespace-nowrap  text-4xl">aaryae</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-white dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="https://aaryadangol.com.np/" className="hover:underline">aaryae</a>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul className="text-white dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="https://github.com/aaryae" className="hover:underline ">Github</a>
                                </li>
                                <li>
                                    <a href="https://discord.gg.com" className="hover:underline">Discord</a>
                                </li>
                            </ul>
                        </div>
                        <div>
